...
function Card(props) {
  return (
    <div  className=' min-h-[350px] bg-[#0d0d27] rounded-2xl p-3 text-2xl text-[gold] hover:border-amber-300  cursor-pointer hover:border-1 hover:translate-y-[-5] transition-all duration-200' style={{boxShadow:"2px 2px 10px indigo"}}>
      <p>{props.data}</p>
